...
describe('ProjectionFieldSet', () => {
  ...
  it('should generate from provided', () => {
    ...
    expect(allFields).toEqual(expect.arrayContaining([['content'], ['users', 'id']]));
  });
  ...
  it('should generate from dotted', () => {
    ...
    expect(allFields).toEqual(
      expect.arrayContaining([['content'], ['users', 'email'], ['users', 'id']])
    );
  });
  ...
  it('should produce dot-joined fields', () => {
    ...
    expect(dotted).toEqual(
      expect.arrayContaining(['users.id', 'users.email', 'notifications.count', 'share'])
    );
  });
